...
Execute unit tests
```
    cd "ShelfSync.Lambda.InvoiceGenerator/test/ShelfSync.Lambda.InvoiceGenerator.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "ShelfSync.Lambda.InvoiceGenerator/src/ShelfSync.Lambda.InvoiceGenerator"
